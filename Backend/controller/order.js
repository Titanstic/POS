...
router.post("/", async (req, res) => {
  ...
  data.forEach(async (d) => {
    ...
    if (d.promotionId === null) {
      ...
      promotionPrice =  (new Date(d.promotion?.startDate + "T00:00:00Z")<= new Date && new Date()<= new Date(d.promotion?.endDate + "T23:59:59Z"))? (d.sale_price - (d.sale_price * d.promotion?.promotionValue/100)) : d.sale_price;
    }
